...
<div className="img-container">
    <article className="d-flex">
     <div className="center">
      <img className="rounded-circle img-fluid img-thumbnail m-4" src={ProfilePic} alt="Myself" />
       </div>
        <div className="m-5">
         <div className="articleBg p-4 rounded">
          ...
          <p className="fs-3">To get in touch with me you can either head to the <a href="#">Contact</a> section and send me a message or take a look at my LinkedIn and message me there!</p>
         </div>
        </div>
    </article>
